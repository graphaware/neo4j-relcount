...
//        database = new TestGraphDatabaseFactory().newImpermanentDatabase();
        database.registerTransactionEventHandler(new FullRelationshipCountTransactionEventHandlerFactory().create(20));
    }
...
//                RandomUsageSimulator simulator = new RandomUsageSimulator(database);
        ...
        int realCount = 0;
        FullRelationshipCounter relationshipCounter = new FullCachedMoreGeneralRelationshipCounter(FRIEND_OF, OUTGOING);
