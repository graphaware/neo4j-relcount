...
import com.graphaware.neo4j.utils.tx.NullItem;
import com.graphaware.neo4j.utils.tx.batch.IterableInputBatchExecutor;
import com.graphaware.neo4j.utils.tx.batch.NoInputBatchExecutor;
import com.graphaware.neo4j.utils.tx.batch.UnitOfWork;
import com.graphaware.neo4j.utils.tx.mutate.DeleteUtils;
...
import static com.graphaware.neo4j.utils.iterable.IterableUtils.random;
...
public class AnotherRandomUsageSimulator {
    ...
    public void batchSimulate(int steps) {
        ...
        new IterableInputBatchExecutor<Node>(database, 10, GlobalGraphOperations.at(database).getAllNodes(), new UnitOfWork<Node>() {
            @Override
