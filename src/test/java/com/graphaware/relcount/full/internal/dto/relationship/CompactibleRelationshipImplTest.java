...
/**
 * Unit test for {@link com.graphaware.relcount.full.internal.dto.relationship.CompactibleRelationshipImpl}.
 */
public class CompactibleRelationshipImplTest {
    ...
    public void shouldGenerateAllMoreGeneral() {
        ...
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE));
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#" + CompactiblePropertiesImpl.ANY_VALUE));
    }
    ...
    public void shouldGenerateAllMoreGeneralWithUnknownKeys() {
        ...
        assertEquals(3, result.size());
        Iterator<CompactibleRelationship> iterator = result.iterator();
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE));
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE));
        Assert.assertEquals(iterator.next(), compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#" + CompactiblePropertiesImpl.ANY_VALUE));
    }
    ...
    public void shouldGenerateAllMoreGeneralWithRedundantUnknownKeys() {
        Set<CompactibleRelationship> result = compactible("test#INCOMING#key1#value1").generateAllMoreGeneral(new HashSet<>(Arrays.asList("key1", "key2")));
    ...
    public void shouldAchieveSpecificToGeneralOrderingForRelationships() {
        ...
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#" + CompactiblePropertiesImpl.ANY_VALUE));
        properties.add(compactible("test#INCOMING#key1#value1#key2#value2"));
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        properties.add(compactible("xx#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        properties.add(compactible("test#OUTGOING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        ...
        Assert.assertEquals(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"), iterator.next());
        Assert.assertEquals(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#" + CompactiblePropertiesImpl.ANY_VALUE), iterator.next());
        Assert.assertEquals(compactible("test#OUTGOING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"), iterator.next());
        Assert.assertEquals(compactible("xx#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"), iterator.next());
    ...
    public void relationshipsShouldBehaveProperlyInTreeSets() {
        ...
        properties.add(compactible("test#INCOMING#key1#value1#key2#value2"));
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2"));
        properties.add(compactible("test#INCOMING#key2#" + CompactiblePropertiesImpl.ANY_VALUE + "#key1#value2"));
        properties.add(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value1"));

        assertTrue(properties.contains(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#" + CompactiblePropertiesImpl.ANY_VALUE)));
        assertTrue(properties.contains(compactible("test#INCOMING#key1#value1#key2#value2")));
        assertTrue(properties.contains(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value2")));
        assertTrue(properties.contains(compactible("test#INCOMING#key1#value2#key2#" + CompactiblePropertiesImpl.ANY_VALUE)));
        assertTrue(properties.contains(compactible("test#INCOMING#key1#" + CompactiblePropertiesImpl.ANY_VALUE + "#key2#value1")));
        assertFalse(properties.contains(compactible("test#INCOMING#key1#value1")));
    }

    @Test
    public void shouldCorrectlyConvertToString() {
        Assert.assertEquals("PREFIXtest#OUTGOING#key1#value1#key2#value2", new CompactibleRelationshipImpl("PREFIXtest#OUTGOING#key1#value1#key2#value2", "PREFIX", "#").toString("PREFIX", "#"));
        Assert.assertEquals("_PREFIX_" + "test#INCOMING", new CompactibleRelationshipImpl("_PREFIX_test#INCOMING", "_PREFIX_", "#").toString("_PREFIX_", "#"));
    }
    ...
    public void sameRelationshipsShouldBeEqual() {
        ...
        assertTrue(new CompactibleRelationshipImpl("test#OUTGOING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE + "", "", "#").equals(new CompactibleRelationshipImpl("test#OUTGOING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE + "", null, "#")));
    ...
    public void differentRelationshipsShouldNotBeEqual() {
        ...
        assertFalse(new CompactibleRelationshipImpl("test2#OUTGOING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE + "", null, "#").equals(new CompactibleRelationshipImpl("test2#OUTGOING#key1#value1#key2#value2", null, "#")));
    ...
    public void verifyMutuallyExclusive() {
        ...
        assertFalse(compactible("test#INCOMING#key1#value1#key2#value2").isMutuallyExclusive(compactible("test#INCOMING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE)));
        assertFalse(compactible("test#INCOMING#key1#value1#key2#value2").isMutuallyExclusive(literal("test#INCOMING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE)));
        assertFalse(compactible("test#INCOMING#key1#value1#key2#value2").isMutuallyExclusive(wildcard("test#INCOMING#key1#value1#key2#" + CompactiblePropertiesImpl.ANY_VALUE)));
    }
