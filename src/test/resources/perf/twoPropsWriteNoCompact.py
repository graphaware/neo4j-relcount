...
data[1, :, :] = np.loadtxt(open("twoPropsSimpleRelcountWriteNoCompaction.txt", "rb"), delimiter=";", dtype=int)
data[2, :, :] = np.loadtxt(open("twoPropsFullRelcountWriteNoCompaction.txt", "rb"), delimiter=";", dtype=int)
...
plt.title('Creating 100,000 Rels with Two Props per Rel, No Compaction')
