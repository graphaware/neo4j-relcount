...
data[0, :, :] = np.loadtxt(open("fourPropsPlainDatabaseWrite.txt", "rb"), delimiter=";", dtype=int)
data[1, :, :] = np.loadtxt(open("fourPropsSimpleRelcountWrite.txt", "rb"), delimiter=";", dtype=int)
data[2, :, :] = np.loadtxt(open("fourPropsFullRelcountWrite.txt", "rb"), delimiter=";", dtype=int)
...
plt.title('Creating 100,000 Rels with Four Props per Rel, With Compaction')
