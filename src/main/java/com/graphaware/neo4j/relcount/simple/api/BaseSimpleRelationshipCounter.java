 ...
 */
public abstract class BaseSimpleRelationshipCounter extends TypeAndDirection implements SimpleRelationshipCounter {
     ...
     */
    protected BaseSimpleRelationshipCounter(RelationshipType type, Direction direction) {
    ...
    /**
     * Return the {@link com.graphaware.neo4j.relcount.common.manager.RelationshipCountManager} used this implementation.
     *
     * @return relationship count manager.
     */
    protected abstract RelationshipCountManager<HasTypeAndDirection> getRelationshipCountManager();
}
