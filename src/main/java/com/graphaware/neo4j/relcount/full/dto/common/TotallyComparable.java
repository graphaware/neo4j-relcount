 ...
 * relative generality.
 *
 * @param <PARTIAL> type that this can be partially compared to.
 * @param <TOTAL> type that this can be mutually totally compared with.
 */
public interface TotallyComparable<PARTIAL, TOTAL extends PartiallyComparable<PARTIAL>> extends PartiallyComparable<PARTIAL>, Comparable<TOTAL> {
}
