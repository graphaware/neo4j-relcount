...
public interface PartiallyComparableRelationship<P extends PartiallyComparableProperties> extends HasTypeDirectionAndProperties<String, P>, PartiallyComparable<HasTypeDirectionAndProperties<String, ?>> {
}
