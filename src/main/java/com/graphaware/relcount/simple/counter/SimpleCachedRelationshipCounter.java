 ...
 * registered with the {@link com.graphaware.framework.GraphAwareFramework} and that you haven't excluded the
 * relationships from caching by means of a custom {@link com.graphaware.tx.event.improved.strategy.RelationshipInclusionStrategy}.
 */
public class SimpleCachedRelationshipCounter extends TypeAndDirection implements SimpleRelationshipCounter {
    ...
    /**
     * Construct a new relationship counter. Use this constructor if {@link com.graphaware.framework.GraphAwareFramework} is used
