...
import com.graphaware.neo4j.relcount.common.internal.cache.BaseBatchFriendlyRelationshipCountCache;
...
/**
 * A full-blown implementation of {@link com.graphaware.neo4j.relcount.common.internal.cache.RelationshipCountCache}.  It is "full" in
...
public class FullRelationshipCountCache extends BaseBatchFriendlyRelationshipCountCache<CompactibleRelationship> implements BatchFriendlyRelationshipCountCache, FrameworkConfigured {
    ...
    protected CompactibleRelationship newCachedRelationship(Relationship relationship, Node pointOfView, Direction defaultDirection) {
        ...
        return new CompactibleRelationshipImpl(relationship.getType(), resolveDirection(relationship, pointOfView, defaultDirection), extractedProperties);
    }
