 ...
 * specific as the relationship description provided to this counter. For example, if this counter is configured to
 * count all OUTGOING relationships of type "FRIEND" with property "strength" equal to 2, all relationships with that
 * specification <b>including those with other properties</b> (such as "timestamp" = 123456) will be counted.
 * <p/>
 * On the other hand, matching relationships counted by the {@link #countLiterally(org.neo4j.graphdb.Node)} method are
 * all relationships that are exactly the same as the relationship description provided to this counter.
