...
public abstract class BaseRelationshipCountCachingNode<CACHED extends SerializableTypeAndDirection> {
    ...
    /**
     * @see {@link com.graphaware.neo4j.relcount.common.internal.node.RelationshipCountCachingNode#getId()}
     */
    public long getId() {
        return node.getId();
    }
    ...
    /**
     * @see {@link com.graphaware.neo4j.relcount.common.internal.node.RelationshipCountCachingNode#incrementCount(com.graphaware.neo4j.dto.common.relationship.HasTypeAndDirection, int)}
     */
    ...
    /**
     * @see {@link com.graphaware.neo4j.relcount.common.internal.node.RelationshipCountCachingNode#decrementCount(com.graphaware.neo4j.dto.common.relationship.HasTypeAndDirection, int)}
     */
    ...
    /**
     * @see {@link com.graphaware.neo4j.relcount.common.internal.node.RelationshipCountCachingNode#deleteCount(com.graphaware.neo4j.dto.common.relationship.HasTypeAndDirection)}
     */
